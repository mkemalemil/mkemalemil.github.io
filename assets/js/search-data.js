...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "Highlights from projects I led or contributed to.",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/qgms/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6D%75%73%74%61%66%61%6B%65%6D%61%6C.%65%6D%69%6C@%77%6D%69%63%68.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/mkemalemil", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0001-5579-0386", "_blank");
        },
      },{
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=ugILX7UAAAAJ&hl", "_blank");
        },
      },{
        id: 'social-scopus',
        title: 'Scopus',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.esrs.wmich.edu/", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
